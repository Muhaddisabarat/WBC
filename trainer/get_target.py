...
from trainer import initialize_trainer, run_training
...
def parse_arguments():
    ...
    parser.add_argument(
        "--config_path",
        type=str,
        default="./configs/pythia-70m-cosmopedia-khanacademy.yaml",
...
def main():
    ...
    model = load_model(model_id, load_pretrained, checkpoint_path)
